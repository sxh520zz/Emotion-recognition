...
def Feature(data):
    ...
    for i in range(len(data)):
        for x in range(len(data[i])):
            input_train_data_trad.append(data[i][x]['trad_data'])
    input_label = []
    for i in range(len(data)):
        for x in range(len(data[i])):
            input_label.append(data[i][x]['label'])
    input_data_id= []
    for i in range(len(data)):
        input_data_id.append(data[i][0]['id'][0][0:-5])
    input_orgin_label = []
    for i in range(len(data)):
        label = []
        for x in range(len(data[i])):
            label.append(data[i][x]['label'])
        input_orgin_label.append(label)
